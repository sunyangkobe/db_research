#ifndef SM_STATS_T_DEC_GEN_CPP
#define SM_STATS_T_DEC_GEN_CPP
...
operator-=(sm_stats_t &s,const sm_stats_t &t)
{
	...
	s.bf_evicted_while_cleaning -= t.bf_evicted_while_cleaning;
	...
	s.rwlock_r_waits -= t.rwlock_r_waits;
	s.rwlock_w_waits -= t.rwlock_w_waits;
	s.need_latch_condl -= t.need_latch_condl;
	s.latch_condl_nowaits -= t.latch_condl_nowaits;
	s.need_latch_uncondl -= t.need_latch_uncondl;
	s.latch_uncondl_nowaits -= t.latch_uncondl_nowaits;
	s.latch_uncondl_waits -= t.latch_uncondl_waits;
	s.btree_latch_wait -= t.btree_latch_wait;
	s.io_latch_wait -= t.io_latch_wait;
	s.bf_look_cnt -= t.bf_look_cnt;
	s.bf_grab_latch_failed -= t.bf_grab_latch_failed;
	s.bf_hit_cnt -= t.bf_hit_cnt;
	s.bf_hit_wait -= t.bf_hit_wait;
	s.bf_hit_wait_any_p -= t.bf_hit_wait_any_p;
	s.bf_hit_wait_btree_p -= t.bf_hit_wait_btree_p;
	s.bf_hit_wait_file_p -= t.bf_hit_wait_file_p;
	s.bf_hit_wait_keyed_p -= t.bf_hit_wait_keyed_p;
	s.bf_hit_wait_lgdata_p -= t.bf_hit_wait_lgdata_p;
	s.bf_hit_wait_lgindex_p -= t.bf_hit_wait_lgindex_p;
	s.bf_hit_wait_rtree_p -= t.bf_hit_wait_rtree_p;
	s.bf_hit_wait_rtree_base_p -= t.bf_hit_wait_rtree_base_p;
	s.bf_hit_wait_extlink_p -= t.bf_hit_wait_extlink_p;
	s.bf_hit_wait_stnode_p -= t.bf_hit_wait_stnode_p;
	s.bf_hit_wait_zkeyed_p -= t.bf_hit_wait_zkeyed_p;
	s.bf_hit_wait_scan -= t.bf_hit_wait_scan;
	s.bf_replace_out -= t.bf_replace_out;
	s.bf_replaced_dirty -= t.bf_replaced_dirty;
	s.bf_replaced_clean -= t.bf_replaced_clean;
	s.bf_replaced_unused -= t.bf_replaced_unused;
	s.bf_awaited_cleaner -= t.bf_awaited_cleaner;
	...
	s.bf_upgrade_latch_unconditional -= t.bf_upgrade_latch_unconditional;
	...
	s.nowait_vol_lock_r -= t.nowait_vol_lock_r;
	s.nowait_vol_lock_w -= t.nowait_vol_lock_w;
	s.await_vol_lock_r -= t.await_vol_lock_r;
	s.await_vol_lock_w -= t.await_vol_lock_w;
	s.io_m_lsearch -= t.io_m_lsearch;
	s.io_m_lsearch_extents -= t.io_m_lsearch_extents;
	s.vol_cache_primes -= t.vol_cache_primes;
	s.vol_cache_prime_fix -= t.vol_cache_prime_fix;
	...
	s.vol_last_page_cache_invalidate -= t.vol_last_page_cache_invalidate;
	s.vol_last_page_cache_find -= t.vol_last_page_cache_find;
	s.vol_last_page_cache_hit -= t.vol_last_page_cache_hit;
	...
	s.log_daemon_wait -= t.log_daemon_wait;
	s.log_daemon_work -= t.log_daemon_work;
	...
	s.log_bytes_written -= t.log_bytes_written;
	s.log_bytes_rewritten -= t.log_bytes_rewritten;
	s.log_bytes_generated_rb -= t.log_bytes_generated_rb;
	s.log_bytes_rbfwd_ratio -= t.log_bytes_rbfwd_ratio;
	s.log_flush_wait -= t.log_flush_wait;
	s.log_short_flush -= t.log_short_flush;
	s.log_long_flush -= t.log_long_flush;
	...
	s.fm_bogus_pbucketmap -= t.fm_bogus_pbucketmap;
	...
	s.any_p_fix_cnt -= t.any_p_fix_cnt;
	s.btree_p_fix_cnt -= t.btree_p_fix_cnt;
	s.file_p_fix_cnt -= t.file_p_fix_cnt;
	s.keyed_p_fix_cnt -= t.keyed_p_fix_cnt;
	s.lgdata_p_fix_cnt -= t.lgdata_p_fix_cnt;
	s.lgindex_p_fix_cnt -= t.lgindex_p_fix_cnt;
	s.rtree_p_fix_cnt -= t.rtree_p_fix_cnt;
	s.rtree_base_p_fix_cnt -= t.rtree_base_p_fix_cnt;
	s.extlink_p_fix_cnt -= t.extlink_p_fix_cnt;
	s.stnode_p_fix_cnt -= t.stnode_p_fix_cnt;
	s.zkeyed_p_fix_cnt -= t.zkeyed_p_fix_cnt;
	s.page_fix_cnt -= t.page_fix_cnt;
	s.bf_fix_cnt -= t.bf_fix_cnt;
	s.bf_refix_cnt -= t.bf_refix_cnt;
	s.bf_unfix_cnt -= t.bf_unfix_cnt;
	s.vol_check_owner_fix -= t.vol_check_owner_fix;
	...
	s.vol_free_page -= t.vol_free_page;
	s.vol_next_page -= t.vol_next_page;
	s.vol_next_page_with_space -= t.vol_next_page_with_space;
	s.vol_find_free_exts -= t.vol_find_free_exts;
	s.xct_log_flush -= t.xct_log_flush;
	...
	s.internal_rollback_cnt -= t.internal_rollback_cnt;
	s.s_prepared -= t.s_prepared;
	s.sdesc_cache_hit -= t.sdesc_cache_hit;
	s.sdesc_cache_search -= t.sdesc_cache_search;
	s.sdesc_cache_search_cnt -= t.sdesc_cache_search_cnt;
	s.sdesc_cache_miss -= t.sdesc_cache_miss;
