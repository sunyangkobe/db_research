...
/*  -- do not edit anything above this line --   </std-header>*/
	...
	void fill(const lpid_t* p, uint2_t tag, int l) {
	  _cat = t_status, _type = t_xct_end_group;
	  logrec_t::fill(p, tag, l);
	}
      public:
	...
	void fill(const lpid_t* p, uint2_t tag, int l) {
      ...
      public:
	xct_prepare_fi_log (int numex, int numix, int numsix, int numextent, const lsn_t& first, int rsvd, int ready, int used);
	...
	void fill(const lpid_t* p, uint2_t tag, int l) {
      ...
      public:
	alloc_file_page_log (const lpid_t& pid, const lsn_t& rec_lsn);
