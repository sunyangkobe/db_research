...
/*  -- do not edit anything above this line --   </std-header>*/
 ...
 w_base_t::base_stat_t rwlock_r_wait;
 w_base_t::base_stat_t rwlock_w_wait;
 w_base_t::base_stat_t needs_latch_condl;
 w_base_t::base_stat_t needs_latch_uncondl;
 w_base_t::base_stat_t latch_condl_nowait;
 w_base_t::base_stat_t latch_uncondl_nowait;
public: 
friend ostream &
